...
我上周去实验室准备测试真实系统的时候，我无法打开陀螺仪旁边的电脑，我发现电脑缺少一个SSD，你知道的，菲利普上周没在实验室，所以我需要帮助，但是他告诉我他明天就会来实验室，我会请他帮我重新调试PC和陀螺仪，然后尽快测试我的训练模型。

```
When I went to the lab last week to prepare for testing the real system, I can't turn on the PC next to the gyroscope, and I found out that the PC is missing an SSD, you know, Philippe wasn't in the lab last week so I need help, but he told me he'll come back to the lab tomorrow and I'll ask him to help me re-tune the PC and gyroscope and then test my training model as soon as possible.
```

另外我的中国导师通知我需要写一篇手稿为我的博士课题。所以，我需要2周时间为我的博士项目写一篇稿子，我是说我必须在8月31日之前完成它。不过，我会花时间测试真实的系统，一旦模拟完成，测试真实的系统会快得多，只是需要更多的测试和对训练模型进行更多的优化。

```
Also my supervisor in China informed me that I need to write a manuscript for my PhD project. So I need 2 weeks to write a manuscript for my PhD project, I mean I have to finish it by 31 August. However, I will make time to test the real system, it will be much faster to test the real system once the simulation is complete, it just requires more testing and more optimization for the training model.
```

这就是我目前的进展，我没有其他的问题了。

```
That's my progress so far, I have no further questions.
```

你知道的，明年我就要博士毕业了，那么从下个月开始我需要开始尝试找工作了，所以，我会尽快完成我的训练模型的实施。

如果我想在EPFL找到一个博士后的职位，我需要达到什么样的学术水平呢？需要我至少有多少篇论文吗？
